          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Hủy vé tàu bạn đã đặt !                
                </div>
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">
                            <a href="pass-cancel-specific-train.php?pass_id=<?php echo $row->pass_id?>"><button class="btn btn-danger btn-sm">Hủy</button></a>  
                        </td>
                      </tr>
                        <?php }?>
                    </tbody>
