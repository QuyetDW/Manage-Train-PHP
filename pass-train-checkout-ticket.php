            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header"><?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?>  Hãy kiểm tra lại vé tàu bạn đã đặt!   
                <?php }?>             
                </div>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a href="pass-checkout-ticket.php?pass_id = <?php echo $row->pass_id;?>"><button class="btn btn-success btn-sm">Xác nhận</button></a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
