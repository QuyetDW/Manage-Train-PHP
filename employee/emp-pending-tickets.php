...
if(isset($_GET['del']))
{
      ...
      $stmt->close();	 
        ...
        if($stmt)
        {
          $succ = "Tàu đã được xóa khỏi hện thống!";
        }
          else
          {
 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
	  <!--Log on to codeastro.com for more projects!-->
          <h2 class="page-head-title">Vé đang chờ duyệt</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Xem vé chờ duyệt</li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ)) {?>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a href ="emp-confirm-tickets.php?ticket_id=<?php echo $row->ticket_id;?>"><button class="btn btn-sm btn-success">Duyệt</button></a> 
                        </td>     
