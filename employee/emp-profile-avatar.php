  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">TT cá nhân </h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Cập nhập avatar<span class="card-subtitle">Hãy điền đầy đủ thống tin</span></div>
                <div class="card-body">
                  <form method ="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Chọn ảnh Avatar mới</label>
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Cập nhập" name = "Update_profile_pic" type="submit">
