...
if(isset($_GET['del']))
{
      ...
      $stmt->close();	 
        ...
        if($stmt)
        {
          $succ = "Tàu đã được xóa khỏi hệ thống!";
        }
          else
          {
 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Quản lý tàu</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Tàu
                  <div class="tools dropdown"><span class="icon mdi mdi-download"></span><a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"><span class="icon mdi mdi-more-vert"></span></a>
                    <div class="dropdown-menu" role="menu"><a class="dropdown-item" href="#">Trạng thái</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->fare;?>đ</td>
                        <td class="center"><?php echo $row->passengers;?></td>
                        <td class="center"><a class ="badge badge-success" href ="emp-update-train.php?id=<?php echo $row->id;?>">Sửa</a> 
                            <hr> <a class ="badge badge-danger" href ="emp-manage-train.php?del=<?php echo $row->id;?>">Xóa</a>
                            <hr><a class ="badge badge-primary" href ="emp-view-train.php?id=<?php echo $row->id;?>">Xem</a>
                        </td>                      
                      </tr>
                        <?php }?>
                    </tbody>
