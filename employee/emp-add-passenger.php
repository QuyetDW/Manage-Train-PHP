	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Tài khoản nhân viên được tạo thành công!";
			}
			else {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Tạo tài khoản khách hàng</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Tạo tài khoản khách hàng<span class="card-subtitle">Hãy điền đầy đủ thông tin</span></div>
                <div class="card-body">
                  <form method ="POST">
