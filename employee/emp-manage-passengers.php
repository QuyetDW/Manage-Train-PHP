...
if(isset($_GET['del']))
{
      ...
      $stmt->close();	 
        ...
        if($stmt)
        {
          $succ = "Xóa khách hàng thành công!";
        }
          else
          {
 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Quản lý hành khách</h2>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Hành khách
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a class ="badge badge-success" href ="emp-update-passenger.php?pass_id=<?php echo $row->pass_id;?>">Sửa</a> 
                            <a class ="badge badge-danger" href ="emp-manage-passengers.php?del=<?php echo $row->pass_id;?>">Xóa</a>
                            <a class ="badge badge-primary" href ="emp-view-pass.php?pass_id=<?php echo $row->pass_id;?>">Xem</a>
                        </td>                      
                      </tr>
                        <?php }?>
                    </tbody>
