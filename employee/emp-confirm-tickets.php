<?php
    ...
    if(isset($_POST['train_fare_confirm_checkout']))
    {
            ...
            if($stmt)
            {
                $succ = "Vé tàu đã được xác nhận thanh toán!";
            }
            else 
            {
  ...
  <body>
	...
	<!--Log on to codeastro.com for more projects!-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Duyệt vé tàu đã thanh toán </h2>
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Xác nhận" name = "train_fare_confirm_checkout" type="submit">
