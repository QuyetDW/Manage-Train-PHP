<?php
    ...
    if(isset($_POST['Update_Profile']))
    {
            ...
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Thông tin cá nhân đã được cập nhập!";
                }
                else 
                {
        ...
        <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item"><a href="#">Cá nhâ</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Cập nhập thông tin cá nhân<span class="card-subtitle">Hãy điền đầy đủ thông tin!</span></div>
                <div class="card-body">
                  <form method ="POST">
