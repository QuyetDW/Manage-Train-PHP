...

    {
            ...
            */
            ...
            $stmt->execute();
                if($stmt)
                {
                    $succ1 = "Cập nhập mật khẩu thành công!";
                }
                else 
                {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Đổi mật khẩu </h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Đổi mật khẩu | Ảnh đại diện </li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ1)) {?>
        ...
        ?>     
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Đổi mật khẩu<span class="card-subtitle">Vui lòng nhập đầy đủ thông tin!</span></div>
                <div class="card-body">
                  <form method ="POST" >
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Mật khẩu mới</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="pass_pwd"  id="inputText3" type="password">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Xác nhận mật khẩu</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name=""  id="inputText3" type="password">
                      </div>
                    </div>
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Đổi mật khẩu" name = "Update_Password" type="submit">
