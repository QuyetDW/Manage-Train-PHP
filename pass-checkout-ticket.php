<?php
    ...
    if(isset($_POST['train_fare_checkout']))
    {
            ...
            */
            ...
            if($stmt)
            {
                $succ = "Vé tàu đã được đặt, vui lòng tiếp tục xác nhận thanh toán";
            }
            else 
            {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Xác nhận vé tàu </h2>
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Xác nhận" name = "train_fare_checkout" type="submit">
