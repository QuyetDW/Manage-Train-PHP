        ...
        <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Đổi mật khẩu | Đổi avatar </li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ1)) {?>
        ...
        ?>     
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Đổi mật khẩu<span class="card-subtitle">Hãy điền đầy đủ thông tin!</span></div>
                <div class="card-body">
                  <form method ="POST" >
                    ...
                    <div class="col-sm-6">
                        <p class="text-right">
                          <input class="btn btn-space btn-success" value ="Xác nhận" name = "Update_Password" type="submit">
