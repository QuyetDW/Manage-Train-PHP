        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-6">
              ...
              <div class="chart sparkline"><i class="material-icons">assignment_late</i></div>
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                  <div class="desc">Đang chờ duyệt</div>
              ...
              <div class="chart sparkline"><i class="material-icons">loyalty</i></div>
                <div class="data-info">
                  <?php
                    ...
                    $stmt->close();
                  ?>
                  <div class="desc">Đã duyệt thành công</div>
            ...
            <div class="chart sparkline"><i class="material-icons">rowing</i></div>
              ...
              <?php
                  ...
                  $stmt->close();
                ?>
                <div class="desc">Khách đặt vé thành công</div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Trạng thái thanh toán vé
                    ...
                    var options = {
                      ...
                      data: [{
                          ...
                          ?>
                            ...
                            { label: "Vé đã duyệt", y: <?php echo $approved;?> },
                            { label: "Vé đang chờ duyệt", y: <?php echo $not_approved;?> },
