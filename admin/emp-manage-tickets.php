 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Quản lý vé tàu</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Quản lý vé tàu</li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ)) {?>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->train_fare;?>đ</td>
                        <td class="center"><?php echo $row->fare_payment_code;?></td>
                        <td class="center"><a class ="badge badge-success" href ="emp-confirm-tickets.php?ticket_id=<?php echo $row->ticket_id;?>">Quản lý</a> 
                            <hr> <a class ="badge badge-danger" href ="emp-manage-tickets.php?del=<?php echo $row->ticket_id;?>">Xóa</a>
                        </td>                      
                      </tr>
                        <?php }?>
                    </tbody>
