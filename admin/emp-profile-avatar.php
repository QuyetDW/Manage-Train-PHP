    ...
    if(isset($_POST['Update_profile_pic']))
    {
            ...
            */
            ...
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Ảnh đại diện đã được cập nhập!";
                }
                else 
                {
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Cập nhập ảnh đại diện<span class="card-subtitle">Hãy điền đầy đủ thông tin</span></div>
                <div class="card-body">
                  <form method ="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Chọn ảnh đại diện mới</label>
