 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Vé tàu đang chờ xử lý</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item active">Xem đang xử lý</li>
            </ol>
          </nav>
        </div>
        <?php if(isset($succ)) {?>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a class ="badge badge-success" href ="emp-confirm-tickets.php?ticket_id=<?php echo $row->ticket_id;?>">Chấp nhận</a> 
                        </td>     
