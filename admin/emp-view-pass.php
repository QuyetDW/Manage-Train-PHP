	...
	include('assets/inc/config.php');
		if(isset($_POST['Create_Profile']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Tài khoản khách được cập nhập!";
			}
			else {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Chi tiết khách hàng</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider"> Chi tiết khách hàng<span class="card-subtitle"></span></div>
                <div class="card-body">
