  ...
  <body>
    ...
    <!--Nav Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Vé tàu</h2>
            ...
            <!--Train Details-->
              <div id='printReceipt' class="invoice">
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Vé tàu được đặt bởi</span><span class="incoice-date"><?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?></span></div>
                </div>
                <div class="row invoice-data">
                  <div class="col-sm-5 invoice-person"><span class="name">Họ tên: <?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?></span><span>Email: <?php echo $row->pass_email;?></span><span>Địa chỉ: <?php echo $row->pass_addr;?></span></div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->pass_train_fare;?>đ</td>
                      </tr>
                      <hr>
                        <?php }?>
                    </tbody>
