 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Tìm kiếm tàu</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass">Trang chủ</a></li>
              <li class="breadcrumb-item"><a href="#">Tàu</a></li>
              <li class="breadcrumb-item active">Tìm kiếm tàu</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Danh sách tàu
