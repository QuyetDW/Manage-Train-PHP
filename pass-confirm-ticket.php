 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Xác nhận thanh toán</h2>
            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header">HI <?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?>!! -  Đây là vé tàu bạn đã đặt. Hãy xác nhận thanh toán !   
                <?php }?>             
                </div>
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><?php echo $row->pass_train_fare;?>đ</td>
                        <td class="center"><?php echo $row->pass_fare_payment_code;?></td>
                        <td class="center"><a href="pass-confirm-checkout-ticket.php?pass_id = <?php echo $row->pass_id;?>"><button class="btn btn-sm btn-success">Xác nhận</button></a></td>
                      </tr>
                        <?php }?>
                    </tbody>
                  </table>
