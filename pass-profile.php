            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="user-info-list card">
                  <div class="card-header card-header-divider">Giới thiệu<span class="card-subtitle"><?php echo $row->pass_bio;?></span></div>
                  <div class="card-body">
                    <table class="no-border no-strip skills">
                      <tbody class="no-border-x no-border-y">
                        ...
                        <tr>
                          ...
                          <td class="item">Điện thoại<span class="icon s7-phone"></span></td>
